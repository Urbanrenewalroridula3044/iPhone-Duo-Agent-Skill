...
111463 1:29–5:12, 111464 2:59–5:00, WWDC26 278 8:19.
...
| --- | --- | --- |
| P1 | Closed, outer display, portrait | Behaves like any iPhone: compact width, horizontal bars. |
...
| P4 | Open flat, inner display, portrait | Bars horizontal again; layout still uses size classes. |
| P5 | Partially folded, book pose | Nothing important spans the fold; alerts, menus, popovers sit clear of it; split views split evenly; custom controls displaced. |
| P6 | Partially folded, tabletop pose | Viewing content on top, interactive controls on the bottom where it applies. |
| P7 | Transitions: close ↔ open, fold ↔ flat | State survives; no jump to root; no stale geometry cached from the previous display; hinge-driven effects reset when not partially open. |
